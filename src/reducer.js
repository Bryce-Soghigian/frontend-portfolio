    ...
    case "handleForward":
      const handleForwardReducer = () => {
        ...
        console.log(currentDate)
           let formatedStartDate = currentDate.slice(0, 2) + "-" + currentDate.slice(2, 4) + "-" + currentDate.slice(6);
             formatedStartDate = new Date(formatedStartDate)
           formatedStartDate.setDate(formatedStartDate.getDate() + 14)
         ...
         let formatedEndDate = currentEndDate.slice(0, 2) + "-" + currentEndDate.slice(2, 4) + "-" + currentEndDate.slice(6);
         formatedEndDate = new Date(formatedEndDate)
         formatedEndDate.setDate(formatedEndDate.getDate()+ 14)
      ...
      let resultsOfForwardReducer = handleForwardReducer();
       ...
       return{
         ...state,
         currentDateRange: [{startDate:resultsOfForwardReducer[0]},{endDate:resultsOfForwardReducer[1]}]
       }
    ...
    case "handleBackwards":
      ...
      let currentDate = state.currentDateRange[0].startDate
       console.log(currentDate)
        ...
        return{
          ...state,
          currentDateRange: [{startDate:newStartDate},{endDate:newEndDate}]
        }
